test_motors.c : A basic script to drive the motors to check that the functions in ../common/mb_motor.c are function. It is helps in checking that the motor defs in ../common/mb_defs.h are behaving as the user desires them to be sign wise. It is compiled in ../bin.
